import { Directive, Host, SkipSelf, OnChanges, EventEmitter, Input, SimpleChanges, ViewContainerRef, TemplateRef, Output, ElementRef, Optional, OnDestroy } from '@angular/core';
...
export class AgmSnazzyInfoWindow implements OnChanges, OnDestroy {
  /**
